...
export class VehicleStatusController {
  ...
  @ApiQuery({ name: 'identification', required: true, description: 'Documento de identidad del cliente', example: '1234567' })
  @ApiResponse({ status: 200, description: 'Estado actual del vehículo', type: PublicVehicleStatusResponseDto })
  ...
  query(@Query() dto: QueryVehicleStatusDto): Promise<PublicVehicleStatusResponseDto> {
